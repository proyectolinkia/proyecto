...
INSERT INTO Productos (referenciaProducto,nombreProducto,descripcionProducto,precioProducto,idCategoriaProductofk,idPuntoVentafk) Select "aa" as referenciaProducto,"bb" as nombreProducto,"cc" as descripcionProducto,55 as precioProducto,(Select idCategoriaProducto From CategoriasProductos where nombreCategoriaProducto="zapatos") as idCategoriaProductofk,(Select idPuntoVenta FROM PuntoVenta where nombrePuntoVenta="demo"&&idEmpresafk=8) as idPuntoVentafk FROM DUAL;
INSERT INTO Productos (referenciaProducto,nombreProducto,descripcionProducto,precioProducto,idCategoriaProductofk,idPuntoVentafk) Select "cc" as referenciaProducto,"cc" as nombreProducto,"dd" as descripcionProducto,44 as precioProducto,(Select idCategoriaProducto From CategoriasProductos where nombreCategoriaProducto="zapatos") as idCategoriaProductofk,(Select idPuntoVenta FROM PuntoVenta where nombrePuntoVenta="demo"&&idEmpresafk=8) as idPuntoVentafk FROM DUAL;
INSERT INTO Productos (referenciaProducto,nombreProducto,descripcionProducto,precioProducto,idCategoriaProductofk,idPuntoVentafk) Select $referencia as referenciaProducto,$nombre as nombreProducto,$descripcion as descripcionProducto,$precio as precioProducto,(Select idCategoriaProducto From CategoriasProductos where nombreCategoriaProducto=$nombreCategoria) as idCategoriaProductofk,(Select idPuntoVenta FROM PuntoVenta where nombrePuntoVenta=$nombrePuntoVenta&&idEmpresafk=1) as idPuntoVentafk FROM DUAL
